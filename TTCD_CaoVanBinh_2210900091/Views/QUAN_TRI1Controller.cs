...
namespace TTCD_CaoVanBinh_2210900091.Views
{
    public class QUAN_TRI1Controller : Controller
    {
        ...
        // GET: QUAN_TRI1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: QUAN_TRI1/Create
